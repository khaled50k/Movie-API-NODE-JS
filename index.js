...
app.get("/", async (req, res) => {
  ...
  const newSeries = new Series({
    ...
    story:
      "A group of young friends in a small town uncover dark secrets when a mysterious girl with telekinetic powers appears.",
  ...
  const newMovie = new Movie({
    ...
    story:
      "A thief with the ability to enter people's dreams is hired to plant an idea into a CEO's mind.",
